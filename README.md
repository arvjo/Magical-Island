# Magical Island
Magical Island is a game for understanding ten friends.<br>
...
Drag and drop objects (folder objects):
ObjectPanel.js - Sets up a panel full of objects, has a lot of different options.
DraggableObject.js - Super class for all draggable objects. Has a lot of options, see more documentation in the file.
Cookies.js - The draggable cookie alternatives at the start in SharkGame.
FinalDragObject.js - The whole draggable cookie in SharkGame.
GoalObject.js - Super class for all goal objects on which you place the draggable objecets.See more documentation in the file.
GoalCookie.js - The specific gola cookie in SharkGame.
